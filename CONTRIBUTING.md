...
This project uses the [Developer Certificate of Origin (DCO)](https://developercertificate.org/) — a lightweight mechanism used by the Linux Foundation in lieu of a CLA. By signing off on your commits, you certify that you have the right to submit the work under the project's MIT license.
