...
> *Open standard.* MCP-I is governed by the [DIF Trusted AI Agents Working Group](https://identity.foundation/working-groups/agent-and-authorization.html). Spec and docs: [modelcontextprotocol-identity.io](https://modelcontextprotocol-identity.io)
...
| [consent-full](examples/consent-full/) | Production consent flow powered by `@kya-os/consent` with multi-mode auth and configurable branding. |
